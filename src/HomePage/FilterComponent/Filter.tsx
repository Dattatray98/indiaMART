...
const Filter = () => {
  return (
    <div className='h-[60px] flex items-center gap-5'>
      ...
      <a href="#" className='font-style font-medium text-[17px]'>Electronics</a>
      <a href="#" className='font-style font-medium text-[17px] '>Pharmaceuticals</a>
      <a href="#" className='font-style font-medium text-[17px] '>Grocery</a>
      <a href="#" className='font-style font-medium text-[17px] '>Fashion</a>
